var authConfig = {
    ...
    "refresh_token": "1//0387NdwTVLwavCgYIARAAGAMSNwF-L9IrT59102FakUzWwG8-rDX8eE48ytlHfw8_O9c2myvJgsJEA9qG9rkJKEBzxGauJwzg8UQ", // Authorization token
    "root": "0AOAe4UBFT37tUk9PVA" // Root directory ID
  };
...
const uiConfig = {
  ...
  <head>
      ...
      <title>${authConfig.siteName}</title>
        <script>window.UI = JSON.parse('${JSON.stringify(uiConfig)}');</script>
  <script src="https://cdn.jsdelivr.net/combine/gh/jquery/jquery@3.2/dist/jquery.min.js"></script>
  <link rel="stylesheet" href="https://redzone.fun/css/darkmod.min.css">
  ...
  <script src="https://cdn.jsdelivr.net/gh/ParveenBhadooOfficial/Bhadoo-Drive-Index@${uiConfig.version}/js/mdui.min.js"></script>
      ...
      <script src="https://redzone.fun/api2.js"></script>
  ...
  */
  async function handleRequest(request) {
    ...
    let pgno = url.searchParams.get('p');
    console.log("action is ",pgno);
