document.write('<link rel="stylesheet" href="//stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">');
document.write('<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/rocky2242/G-drive_index_v4.1/api/style.css">');
document.write('<script src="//code.jquery.com/jquery-3.3.1.slim.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script>');
document.write('<script src="//stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>');
// Initialize the page
function init() {
...
function nav(path) {
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="#">Join our growing forum!</a>
        </div>
      </li>
    </ul>
      `;
	...
	var search_bar = `<form class="form-inline my-2 my-lg-0">
...
function append_files_to_list(path, files) {
	...
	for (i in files) {
		...
		if (item['mimeType'] == 'application/vnd.google-apps.folder') {
			...
			html += `
        		<a class="card" href="${p}">
      <span class="card-header" style="background-image: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQItDkLRAkxz2Obu_ZvDYmdbg6xEQ7Nd4yhEVc4NzXvMh1GJ9sy&s);">
      </span>
      ...
      <span class="card-meta">
        FOLDER:Click to Enter
          ...
          $("img").addClass("img-fluid")
			...
			html += `
    <a class="card" href="${p}">
      <span class="card-header" style="background-image: url(${res});">
      </span>
      <span class="card-summary">
        ${item.name}
      </span>
