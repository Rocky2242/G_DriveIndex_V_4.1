	...
	for (i in files) {
		...
		if (item['mimeType'] == 'application/vnd.google-apps.folder') {
			html += `<div class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-3">
                        <a href="${p}" class="card">
                             <img class="card-img-top" src="https://findicons.com/files/icons/1029/vista_folder_colors/256/black_folder.png" style="height: 120px">
                                <div class="card-body">
...
function append_search_result_to_list(files) {
	...
	for (i in files) {
		...
		if (item['mimeType'] == 'application/vnd.google-apps.folder') {
			...
			html += `<div class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-3">
                        <a onclick="onSearchResultItemClick(this)" id="${item['id']}" class="card">
			...
			html += `<div class="col-12 col-sm-4 col-md-3 col-lg-3 col-xl-3">
                        <a onclick="onSearchResultItemClick(this)" id="${item['id']}" gd-type="${item.mimeType}" class="card">
                             <img class="card-img-top" src="${res}">
                                <div class="card-body">
                                <p class="card-text">${item.name}<br>Size:${item['size']}</p>
                                </div>
